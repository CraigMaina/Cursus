...
/**
 * Token-styled form building blocks, local to the goals screens (mirrors the vices
 * module's field kit so goals stays self-contained). Plaster ground, ink text, egyptian
 * focus ring, no inline hex. Screens spread react-hook-form's `register` onto native
 * controls, so keyboard and screen-reader behaviour is native.
 */

/** Class for text/number/date inputs, selects and textareas. `invalid` swaps the border. */
